...
<div class='container'>
    <div class="content">
        ...
        <br>
        <form method="POST" action="{{ route('operation.store', ['customerId' => $customerId]) }}">
        @csrf

            <div class="row border rounded">
            <div class="row">
                <div class="col">
                    <label for="customer_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Company:</label>
                    <input type="text" name="customer_name" value="{{ $customer->name }}">
                </div>
                <div class="col">
                    <label for="stockroom_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Stockroom:</label>
                    <input type="text" name="stockroom_name" value="{{ $stockroom->name ?? '' }}">
                </div>
                <div class="col">
                    <label for="doc_req" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Documentation Requirements:</label>
                    <input type="text" name="doc_req" value="{{ $customer->doc_req ?? '' }}">
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="user_avatar">Receiving Document/s:</label>
                    <textarea id="doc_ref" rows="4" name="doc_ref" class="block p-2 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Delivery Receipt/Transmittal Form..."></textarea>
                </div>
                <div class="col">
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="user_avatar">Upload file</label>
                    <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="user_avatar_help" id="attachments" type="file" name="attachments">
                </div>
            </div>
        </div>

        <!-- <button type="submit" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Add Item</button> -->
                    ...
                    <tr>
                        <td class="border border-slate-300 ...">
                            <div class="w-1/4 px-2">
                                <select id="product_name" name='product_name' class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <td class="border border-slate-300 ...">
                            <input type="number" id="product_qty" name="product_qty" class="w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </td>
                        <td class="border border-slate-300 ...">
