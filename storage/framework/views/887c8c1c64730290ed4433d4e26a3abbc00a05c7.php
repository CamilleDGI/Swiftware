        ...
        <div class="row">
            ...
            <table class="border-collapse border border-slate-400 ...">
                ...
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="border border-slate-300 ..."><?php echo e($product['product_id']); ?></td>
                        <td class="border border-slate-300 ..."><?php echo e($product['product_name']); ?></td>
                        <td class="border border-slate-300 ..."><?php echo e($product['quantity']); ?> <?php echo e($product['measurement']); ?></td>
                        <td class="border border-slate-300 ..."><?php echo e($product['status']); ?></td>
...
<?php echo $__env->make('layouts.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Documents\CAMILLE\WD48PCapstone\swiftware\resources\views/product/products.blade.php ENDPATH**/ ?>